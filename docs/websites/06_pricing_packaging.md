# Step 6 — Pricing & Packaging (RankSentinel)

This step defines the **pricing page content** (copy + tier table + clarifications) for RankSentinel.
...
|---|---:|---|---|
| **Starter** | **$29/mo** | 1 small site | 1 site, up to **50 pages monitored**, up to **10 key pages**, up to **3 recipients** |
...
- you need more **key pages** (daily monitoring + PSI)
...
**Can I add another site later?**  
Yes — upgrade to Growth or Agency.

---

## Notes for future iteration

- If we add an annual plan later, anchor annual at ~2 months free (common pattern).
- If enterprise needs custom contracts, keep Agency as the highest self-serve tier and add “Enterprise — Contact” as a fourth option.
