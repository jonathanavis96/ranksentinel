...
def test_fetch_pages_handles_errors(mock_fetch_text):
    ...
    mock_results = [
        ...
        FetchResult(status_code=404, final_url="https://example.com/page2", body="not found", error="HTTP 404", error_type=ErrorType.HTTP_4XX),
        FetchResult(status_code=500, final_url="https://example.com/page3", body="error", error="HTTP 500", error_type=ErrorType.HTTP_5XX),
